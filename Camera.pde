class Camera
{
  Camera()
  {
    position      = new PVector( 88.192955, -125.328285, 209.16246 ); // initial position
    theta         =   0.38827577; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.44401667; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 50;
